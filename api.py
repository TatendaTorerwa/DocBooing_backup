...
@app.route('/doctors/<int:doctor_id>', methods=['DELETE'], strict_slashes=False)
...
@app.route('/appointmenets/<int:appointment_id>', methods=['GET'], strict_slashes=False)
...
@app.route('/appointments/<int:appointment_id>', methods=['PUT'], strict_slashes=False)
...
@app.route('/locations/<int:location_id>', methods=['GET'], strict_slashes=False)
